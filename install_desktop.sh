...
sudo apt-get --allow-unauthenticated --no-install-recommends -qy install xfce4 xinit xdm gmpc gmpc-plugins
sudo apt-get --allow-unauthenticated -qy install xserver-xorg
